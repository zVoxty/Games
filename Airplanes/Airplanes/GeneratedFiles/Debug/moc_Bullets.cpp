...
const QMetaObject Bullets::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Bullets.data,
      qt_meta_data_Bullets,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Bullets::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Bullets*>(this));
